...
//Pentru tipurile de joc, mai este nevoie de un set de carti(Card)
...
//La impartirea cartilor(deal) se distribuie fiecarui jucator un
// subset de carti din setul predefinit al jocului curent
// astfel ca se genereaza pentru fiecare player(cheie) un set de carti aleator(valoare).
//
//Pentru jocul de BlackJack se distribuie cate 5 carti
// fiecarui jucator si castiga jucatorul care are suma cartilor cea mai apropiata de 21.
//
...
//
//Daca se incearca inceperea unui joc u un numar mai mare de
// jucatori decat cel suportat de jocul respectiv,
